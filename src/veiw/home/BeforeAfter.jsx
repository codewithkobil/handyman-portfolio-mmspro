...
const projects = [
	{
		...
		description: "Complete overhaul of a dated kitchen into a modern culinary space.",
		before: beforeImage,
		after: afterImage
	},
	{
		...
		description: "Transforming a cramped bathroom into a spa-like retreat.",
		before: "https://picsum.photos/seed/bath_old/1000/600",
		after: "https://picsum.photos/seed/bath_new/1000/600"
	},
	{
		id: 3,
		title: "Living Room Remodel",
		description: "Opening up the living space for better flow and natural light.",
		before: "https://picsum.photos/seed/living_old/1000/600",
		after: "https://picsum.photos/seed/living_new/1000/600"
	}
];
...
const BeforeAfter = () => {
	return (
		<section id="beforeAfter" className="w-full bg-slate-900 py-20 px-4 sm:px-8 lg:px-16">
			<div className="max-w-7xl mx-auto">
				<div className="text-center mb-12">
					...
					<p className="text-slate-300 max-w-2xl mx-auto text-lg">
						See the difference we make. Drag the slider to compare the before and after states of our renovation projects.
					</p>
				</div>
